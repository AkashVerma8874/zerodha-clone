...
function Hero() {
    return ( 
        <div className="container">
            ...
            <div className="row p-3 mt-5 border-top text-muted" 
               style={{lineHeight:"1.8",fontSize:"1.08rem",fontWeight:"450"}}
            >
                   ...
                   <div className="col-6 p-5">
                       ...
                       <p>
                           And yet, we are always up to something new every day. Catch up on the latest updates on our <a href="">blog</a> or see what the media is <a href="">saying about us</a> or learn more about our business and product philosophies.
                       </p>
                   </div>
            </div>
        </div>
